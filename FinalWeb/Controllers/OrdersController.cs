...
namespace FinalWeb.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderID,Date,Status,PaymentMethod,AgentID,Order_Total_Price,PaymentStatus")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderID,Date,Status,PaymentMethod,AgentID,Order_Total_Price,PaymentStatus")] Order order)
        {
            if (ModelState.IsValid)
            {
